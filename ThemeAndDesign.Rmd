    ...
    labs(title = "The United States spends trillions of dollars on tax loopholes each year", 
         ...
         x = "Category of Tax Break") +              
          ...
          theme(plot.title = element_text(color="black", size=14, face="bold", hjust = 0.5),
              ...
              axis.title.x = element_text(color="black", size=14), axis.text.x = element_blank(),
...
theme1 <- theme(plot.title = element_text(color="black", size=14, face="bold", hjust = 0.5),
                plot.subtitle = element_text(color="black", size=12, hjust =0.5),
...
descr <- labs(title = "The Largest Individual Tax Breaks", 
...
ggsave(filename = 'visuals/BiggestIndividualBreaks.pdf', width = 11, height = 8.5)
last_plot()
```
