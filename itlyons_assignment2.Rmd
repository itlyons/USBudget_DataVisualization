...
outlays %>%
  filter(agency_name %in% c("Social Security Administration","Department of Health and Human Services","Department of Defense--Military Programs"
	,"Department of the Treasury","Department of Agriculture", "Department of Veterans Affairs", "Department of Labor", "Office of Personnel Management")) %>% 
