...
ggsave('tax_expenditures_to_2028.pdf', path="visuals/", width=18, height=9, units='in')
```


## Read in Federal Budget Outlays data
...
## Group by agency name and sum expenditures within the same agency and year.
