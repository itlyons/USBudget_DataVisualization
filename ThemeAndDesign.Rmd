...
discvmand <- ggplot(data=v2_spendtype, 
  ...
  scale_y_log10(name = "Mandatory Outlays (2018)", 
                labels = scales::dollar_format(scale=.000001, 
                                               accuracy = .01, 
                                               suffix = 'B')) + 
  scale_x_log10(name = "Discretionary Outlays (2018)", 
                labels = scales::dollar_format(scale=.000001, 
                                               accuracy = .01, 
                                               suffix = 'B')) + 
  ...
  iltheme +
  geom_text(size=2, 
            aes(label=ifelse(mandatory>10000 & discretionary > 10000, 
  ...
  scale_color_gradient(low = '#66A61E', 
                       ...
                       labels = scales::percent_format(),  breaks = seq(0,1,by=.25)) +
  scale_size_continuous(limits = c(0, 160000000),
                        name = "Total Spending", 
                        range = c(0,10), 
                        labels = scales::dollar_format(scale=.000001, 
                                               accuracy = .01, 
